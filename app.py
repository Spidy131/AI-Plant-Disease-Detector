...
st.markdown(
    '<div class="main-title">🌿 AI Plant Disease Detector</div>',
    unsafe_allow_html=True
)
...
if uploaded_file:
    ...
    with right:
        ...
        try:
            ...
            knowledge = search_disease(
                f"Tomato {disease_name}"
            )


            # --------------------------
            # Disease NOT in ChromaDB
            # --------------------------
            ...
            # --------------------------
            # Disease FOUND in ChromaDB
            # --------------------------

            else:

                info = format_disease_info(
                    knowledge
                )
...
st.markdown(
    """
    <div class="footer">
        🌿 Built with TensorFlow • Streamlit • ChromaDB • Gemini 2.5 Flash
    </div>
    """,
    unsafe_allow_html=True
)
